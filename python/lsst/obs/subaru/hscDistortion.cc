...
PYBIND11_PLUGIN(_hscDistortion) {
    ...
    py::class_<DistortionPolynomial, std::shared_ptr<DistortionPolynomial>> clsDistortionPolynomial(mod, "DistortionPolynomial");

    clsDistortionPolynomial.def(py::init<int, int, typename DistortionPolynomial::Coeffs const&, typename DistortionPolynomial::Coeffs const&>(),
    ...
    py::class_<HscDistortion, std::shared_ptr<HscDistortion>, afw::geom::XYTransform> clsHscDistortion(mod, "HscDistortion");

    clsHscDistortion.def(py::init<DistortionPolynomial const&, DistortionPolynomial const&, afw::geom::Angle const&, double, int>(),
"skyToCcd"_a, "ccdToSky"_a, "plateScale"_a=1.0*afw::geom::arcseconds, "tolerance"_a=5.0e-3, "maxIter"_a=10);
