...
typedef struct {
   ...
   float field;				/* field object belongs to */
   float rowc, colc;			/* center of object */
   float counts;			/* number of counts in object */
   float countsErr;                     /* counts error */
   float peak_residual;			/* peak value of residual after subtracting KL PSF */
   int peak_residual_rpeak, peak_residual_cpeak; /* position in reg of peak residual */
