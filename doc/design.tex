...
% SDSS section
% python examples/designdoc.py --drill 828 --order 1,0,2

% Monotonic section
% python examples/designdoc.py --drill 1173 --figh 2.5
% python examples/designdoc.py --drill 1173 --figh 2.5 --mono --prefix design-mono-
% python examples/designdoc.py --drill 2439 --figw 3 --order 3,0,1,2
% python examples/designdoc.py --drill 2439 --figw 3 --order 3,0,1,2 --mono --prefix design-mono-
